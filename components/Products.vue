  ...
  <div>
    <div class="card-image">
      <figure class="image is-4by3">
        ...
        <img v-bind:src="product.imagem" alt="Placeholder image"/>
      </figure>
    </div>
    <div class="card-content">
      ...
      <div class="content is-clearfix">
        ...
        <div class="is-pulled-left">
          ...
          <i v-if="product.ratings === 5" class="fa fa-star"></i>
          <i v-if="product.ratings === 5" class="fa fa-star"></i>
          <p>{{ product.reviews > 0 ? `${product.reviews} Reviews` : 'Sem reviews' }}</p>
        </div>
        <p class="is-pulled-right">
          <span class="title is-4"><strong>&real; {{ product.price }}</strong></span>
        </p>
      </div>
